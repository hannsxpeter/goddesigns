...
The project owner reviewed the renders and ranked fd-b FIRST on visual appeal, with gd-c (the cinematic specimen sheet) a close second and the remaining goddesign runs behind. This is recorded as ground truth, not explained away. Diagnosis, refined by the close second: the differentiator is concreteness, not palette mood. The two top pages pair strong form with structured product substance (fd-b: ledger tables, invoice cards, the page IS a ledger; gd-c: annotation tables under its giant serif plates), while the trailing runs are the most abstract (gd-a's pure manifesto, assertion without artifact) and the most subdued (gd-b's quiet letter). Dark drama nearly won; drama without product evidence did not. The catch: fd-b's winning move is the same subject-to-obvious-concept mapping that made all three fd runs identical and put Young Serif in 5 of 6, and fd-b still fabricated a trust stat and failed target sizes. Lesson encoded into the skill same day: the Step 4b Subject test (signature and at least one motif must be artifacts of the subject's world drawn in the locked direction's formal language; show the product working), a sharpened Specificity axis, and an explicit audience-fit remix trigger in Step 3c. Seed keeps supplying the form; the subject must now supply the matter.
