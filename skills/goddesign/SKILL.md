...
- [fingerprint] Inter, Roboto, Arial, Open Sans, Lato, Poppins, or a system stack as a chosen face. INSTEAD: the direction row's fonts, or a `fonts.md` pairing.
